...
# Require password after 15 seconds after sleep or screen saver begins
...
# To enable app updates from the Mac App Store to be installed automatically:
sudo defaults write /Library/Preferences/com.apple.commerce AutoUpdate -bool TRUE

# To enable OS X updates to be installed automatically
